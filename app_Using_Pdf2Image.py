...
input_prompt3 = """
You are an skilled ATS (Applicant Tracking System) scanner with a deep understanding of any one job role from data science, full stack, DevOps, Data Analyst, Big Data Engineering, Web Development , database administrator and ATS functionality, 
your task is to evaluate the resume against the provided job description. give me the percentage of match if the resume matches the job description. Do not give me any other output than value in percentage.
Be strict with the resume matching and should thoroughly analyze the job description and my resume to give accurate answer onlys
"""
